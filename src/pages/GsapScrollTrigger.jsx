    ...
    () => {
      ...
      boxes.forEach((box) => {
        gsap.to(box, {
          ...
          // First box: x = 150 * (0 + 5) = 750
          // Second box: x = 150 * (1 + 5) = 900
          rotation: 360,
          borderRadius: "100%",
          scale: 1.5,
          scrollTrigger: {
            trigger: box,
            start: "bottom bottom",
            // The first "bottom" refers to the bottom edge of the trigger element (the box).
            // The second "bottom" refers to the bottom edge of the viewport (browser window).
            // So, the animation starts when the bottom of the box touches the bottom of the viewport as you scroll.
            end: "top 20%", // Animation ends at 20% viewpoint of the box
            scrub: true, // Animation smooth
          },
          ease: "power1.inOut",
        });
      });
