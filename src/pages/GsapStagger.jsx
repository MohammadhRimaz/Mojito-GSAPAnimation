...
const GsapStagger = () => {
  ...
  useGSAP(() => {
    gsap.to(".stagger-box", {
      ...
      repeat: -1,
      yoyo: true,
      // stagger: 0.5, // In a group of same animation element, target one by one to perform the animation
      stagger: {
        amount: 1.5, // In a group of same animation element, target one by one to perform the animation
        grid: [2, 1],
        axis: "y",
        ease: "circ.inOut",
        from: "center", // Set the starting point of animation in a group of element to center
      },
    });
  }, []);
